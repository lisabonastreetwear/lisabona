...
describe("regras do chatbot", () => {
  ...
  it("valida identificadores sem aceitar fragmentos curtos", () => {
    ...
    assert.equal(identityLooksValid("912345678"), true);
    assert.equal(identityLooksValid("123"), false);
  });

  it("confirma a identidade por email ou telefone", () => {
    ...
    assert.equal(customerMatchesOrder(order, "912345678", "351900000000"), true);
